...
namespace proyWinProcesosFcFs
{
    public partial class Form1 : Form
    {
        ...
        (2 * dgvDatos.Columns[0].HeaderCell.Size.Height / 3);
            ...
            //Generando las columnas del Datagriewview
            dgvDatos.Columns[0].Name = "Proceso";
            dgvDatos.Columns[1].Name = "T.Llegada.";
            dgvDatos.Columns[2].Name = "T.Finalizacion";
            dgvDatos.Columns[3].Name = "T.Servicio ";
            dgvDatos.Columns[4].Name = "T.Espera ";
            dgvDatos.Columns[5].Name = "T.Retorno.";
            dgvDatos.Columns[6].Name = "T.R.Normalizado.";
